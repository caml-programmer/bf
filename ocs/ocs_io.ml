...
let display th cc =
  function
    [| obj |] ->
      let p = get_stdout th in print p true obj; Ocs_port.flush p; cc Snull
  | [| obj; Sport p |] -> print p true obj; Ocs_port.flush p; cc Snull
...
let write th cc =
  function
    [| obj |] ->
      let p = get_stdout th in print p false obj; Ocs_port.flush p; cc Snull
  | [| obj; Sport p |] -> print p false obj; Ocs_port.flush p; cc Snull
...
let write_char th cc =
  function
    [| Schar c |] ->
      let p = get_stdout th in Ocs_port.putc p c; Ocs_port.flush p; cc Snull
  | [| Schar c; Sport p |] -> Ocs_port.putc p c; Ocs_port.flush p; cc Snull
